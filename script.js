function Encrypt(){
    ...
    let test = document.getElementById("Plaintext_Input").value

    if (SET1.includes(test) == true){
        SET2 = [];
        ...
        document.getElementById("Error_Output").innerText = `ERROR: The entered value contains characters that haven't been added yet to our database.`;
    }
}
